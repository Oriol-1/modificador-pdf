...
class TestWorkGroup:
    ...
    def test_workgroup_stats_empty(self):
        ...
        assert group.is_complete() == False  # Sin cambios = incompleto
...
class TestWorkspaceManager:
    ...
    def test_get_pending_pdfs_all_groups(self):
        ...
        with open(pdf2, 'w') as f:
            f.write("fake pdf 2")
        group = self.manager.create_new_group([pdf2])
        
        # Obtener pendientes del grupo actual
        all_pending = group.get_pending_pdfs()
